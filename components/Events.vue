<template>
  <div class="p-4 md:p-8 my-16">
    ...
    <div class="flex flex-wrap items-center mt-8 w-full border-b font-danaReg py-4">
      <div class="input-search-box w-full lg:w-1/4 lg:border-l px-4 mb-8 border-b after:-bottom-0 lg:after:-bottom-4 lg:border-b-0 lg:mb-0">
        <IconField class="">
      ...
      <div
          class="input-search-box border-b md:border-b-0 w-full md:w-1/3 lg:w-1/4 md:border-l px-4">
        <IconField>
          <InputIcon class="pi pi-map" style="color:#4457ff"/>
          <Select v-model="selectedLocation" :options="locations" class="w-full font-danaReg p-2" filter optionLabel="name"
                  placeholder="موقعیت" showClear/>
        </IconField>
      </div>
      <div
          class="input-search-box border-b md:border-b-0 w-full md:w-1/3 lg:w-1/4 md:border-l px-4">
        <IconField>
          ...
          <Select v-model="selectedCategory" :options="categories" class="w-full font-danaReg p-2" optionLabel="name"
                  placeholder="دسته بندی" showClear/>
        </IconField>
      ...
      <div class="input-search-box w-full md:w-1/3 lg:w-1/4 px-4">
        <IconField>
          ...
          <Select v-model="selectedType" :options="type" class="w-full font-danaReg p-2" optionLabel="name" placeholder="نوع رویداد"
                  showClear/>
        </IconField>
